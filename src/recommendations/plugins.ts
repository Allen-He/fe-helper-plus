export const recommendedPlugins = [
  ...
  },
  {
    ...
    description:
      "Provides problem matchers for TypeScript projects using Webpack with ts-loader, fork-ts-checker-webpack-plugin with or without eslint, and/or tslint-loader",
  },
  {
  ...
  { id: "Dunn.redis", displayName: "Redis", description: "Redis For VS Code" },
  {
    id: "eamodio.gitlens",
